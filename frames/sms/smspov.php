...
<body onload="calcolaLunghezza();">
	<div class="cornicepov">SMS - Vendita Porsche
	</div>
	<!--scelta dei modelli-->
	<div id="modelli">
		<?php
			$query="SELECT * FROM modellipov WHERE stato=1";
								...
								<tr>
									<td>
										<select id="ext" name="ext" class="chr" form="messaggio" onchange="modificaExtra();">
											<?php
												$query="SELECT * FROM extravwv WHERE stato=1 ORDER BY ID ASC";
				...
				<tr>
					...
					<td>
						<div id="chiusura_cont" class="contenuto">
							...
							<div id="col">
								<?php
									mysqli_select_db($db2_name, $db)
										or die ("Errore nella selezione del database. Verificare i parametri nel file config.inc.php");
									$query="SELECT nome,telefono,marche.marca AS mc FROM collaboratori,marche,funzioni WHERE collaboratori.ID=collaboratore AND programma=14 AND collaboratori.marca=marche.ID ORDER BY mc";
