...
<div>
	<?php
		if ($_POST[tipo]!='storico') {
			echo '<button onclick="carb_close_lista();">Annulla</button>';
		}
		else {
			echo '<button onclick="carb_close_st_lista();">Annulla</button>';
		}
	?>
</div>

<br/>
<h2>Annullamento buono:</h2>
...
<div>
	...
	<div style="margin-top:5px;">
		<label style="margin-right:40px">Annullamento nota</label>
		<br/>
		<input type="text" id="carb_annulla_nota" maxlength="40" style="width:212px;" value=""/>
	</div>
	
	<div style="margin-top:10px;">
		<label>Password</label>
		<input style="margin-left:20px;" type="password" id="carb_annulla_pw" onkeydown="if(event.keyCode==13) carb_close_annulla();"/>
	</div>
	
	<div id="carb_annulla_error" class="carb_error"></div>
	
	<?php
		if ($_POST[tipo]!='storico') {
	?>
		<div style="margin-left:300px;margin-top:10px;float:left;">
			<button onclick="carb_close_annulla();"><img style="width:30px;height:30px;" src="img/annulla.png"/></button>
		</div>
	<?php
		}
		else {
	?>
		<div style="margin-left:300px;margin-top:10px;float:left;">
			<button onclick="carb_close_st_annulla();"><img style="width:30px;height:30px;" src="img/annulla.png"/></button>
		</div>
	<?php
		}
	?>
