...
<div>
	...
	<div>
		<label>importo</label>
		<input style="margin-left:32px;text-align:right;" type="text" id="carb_fill_importo" value=""/>
	</div>
	
	<div style="margin-top:5px;">
		<label style="margin-right:40px">Nota</label>
		<input type="text" id="carb_fill_nota" size="30" maxlength="40" value="<?php echo $obj->nota;?>"/>
	</div>
	
	<div style="margin-top:10px;">
		<label>Password</label>
		<input style="margin-left:20px;" type="password" id="carb_fill_pw" onkeydown="if(event.keyCode==13) carb_close_fill();"/>
	</div>
	
	<div id="carb_fill_error" class="carb_error"></div>
	
	
	<div style="margin-left:300px;margin-top:10px;float:left;">
		<button onclick="carb_close_fill();"><img style="width:30px;height:30px;" src="img/fill.png"/></button>
	</div>
