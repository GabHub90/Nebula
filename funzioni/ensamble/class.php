    ...
    function setRibbonFunctions() {
        ...
        $this->cls['nebulaDraw']=function() {
            ...
            echo '<div style="position:relative;margin-top:5px;">';
                ...
                //////////////////////////////////////////////////
                echo '<input id="ribbon_ens_today" type="'.$this->mappa['today']['prop']['tipo'].'" class="js_chk_'.$this->form_tag.'" value="'.$this->mappa['today']['prop']['default'].'" js_chk_'.$this->form_tag.'_tipo="today" />';
                echo '<input id="ribbon_ens_reparto" type="'.$this->mappa['reparto']['prop']['tipo'].'" class="js_chk_'.$this->form_tag.'" value="'.$this->mappa['reparto']['prop']['default'].'" js_chk_'.$this->form_tag.'_tipo="reparto" />';
