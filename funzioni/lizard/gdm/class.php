    ...
    function setRibbonFunctions() {
        ...
        $this->cls['nebulaDraw']=function() {
            ...
            echo '<div style="position:relative;margin-top:5px;">';
                ...
                echo '<div style="display:inline-block;width:10%;text-align:left;vertical-align:top;">';
                    echo '<div style="position:relative;display:inline-block;font-weight:bold;font-size:1em;width:25%;vertical-align:top;">GDM:</div>';
                    echo '<div style="position:relative;display:inline-block;width:75%;vertical-align:top;">';

                        echo '<div>';
                            echo '<input type="hidden" id="'.$this->form_tag.'_liz_function" value="'.$this->mappa['liz_function']['prop']['default'].'" class="js_chk_'.$this->form_tag.'" js_chk_'.$this->form_tag.'_tipo="liz_function">';
                        echo '</div>';
