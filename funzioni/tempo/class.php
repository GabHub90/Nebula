    ...
    function setRibbonFunctions() {
        ...
        $this->cls['nebulaDraw']=function() {
            ...
            echo '<div style="position:relative;margin-top:5px;">';
                ...
                echo '<div>';
                    echo '<div>';
                        echo '<select id="ribbon_tpo_macroreparto" style="width:95%;font-size:1em;" class="js_chk_'.$this->form_tag.'" js_chk_'.$this->form_tag.'_tipo="macroreparto" onchange="window._js_chk_'.$this->form_tag.'.setMacrorep();" ';
                ...
                //////////////////////////////////////////////////
                echo '<input id="ribbon_tpo_today" type="'.$this->mappa['today']['prop']['tipo'].'" class="js_chk_'.$this->form_tag.'" value="'.$this->mappa['today']['prop']['default'].'" js_chk_'.$this->form_tag.'_tipo="today" />';
                echo '<input id="ribbon_tpo_reparto" type="'.$this->mappa['reparto']['prop']['tipo'].'" class="js_chk_'.$this->form_tag.'" value="'.$this->mappa['reparto']['prop']['default'].'" js_chk_'.$this->form_tag.'_tipo="reparto" />';
                echo '<input id="ribbon_tpo_coll" type="'.$this->mappa['coll']['prop']['tipo'].'" class="js_chk_'.$this->form_tag.'" value="'.$this->mappa['coll']['prop']['default'].'" js_chk_'.$this->form_tag.'_tipo="coll" />';
                echo '<input id="ribbon_tpo_divo" type="'.$this->mappa['divo']['prop']['tipo'].'" class="js_chk_'.$this->form_tag.'" value="'.$this->mappa['divo']['prop']['default'].'" js_chk_'.$this->form_tag.'_tipo="divo" />';
